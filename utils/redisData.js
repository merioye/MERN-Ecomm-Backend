...
class RedisData{
    ...
    getCategories = async ()=>{
        try{
            let categoriesData = await redisService.getAllValuesFromList('categories');
            if(!Boolean(categoriesData.length)){
                ...
                categoriesData = await redisService.getAllValuesFromList('categories');
            }
    ...
    getProducts = async ()=>{
        try{
            let productsData = await redisService.getAllValuesFromList('products');
            if(!Boolean(productsData.length)){
                ...
                productsData = await redisService.getAllValuesFromList('products');
            }
            return productsData;
        }catch(e){
            throw e;
